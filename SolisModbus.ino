...
3Thee signed 16bit values are unsigned because the ModbusMaster library only returns uint16_t type.
...
const char broker[] = "192.168.119.151";//"xxx.xxx.xxx.xxx"; //"core-mosquitto";
//char thingsboardServer[] = "192.168.119.151";
int        port     = 8080; //your port here
int count = 0;
...
//MQTT Connection here
  ...
  // You can provide a username and password for authentication
   mqttClient.setUsernamePassword("tenant", "tenant");

  Serial.print("Attempting to connect to the MQTT broker: ");
  Serial.println(broker);

  if (!mqttClient.connect(broker, token, "")) {
